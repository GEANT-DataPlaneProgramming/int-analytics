...
line_body = []
for i in range(CNT):
    line_body.append("int_telemetry,srcip=10.0.0.1,dstip=10.0.0.2,sctp=1111,dstp=80 seq=%d,srcts=%d,dstts=%d,delay=%d,sink_jitter=%d,reordering=0 %d" % 
...
#~ client.send_packet(line_body, time_precision='n',protocol='line')
