...
def create_delay(int_reports, flow, starttime, duration):
    ...
    p = figure(title="simple line example", x_axis_label='x', y_axis_label='y', plot_width=3200, plot_height=1400)
    p.xaxis[0].formatter = DatetimeTickFormatter(microseconds=[ "%f" ],
                                                      milliseconds=[ "%f" ],
                                                      seconds     =[ "%F" ],
                                                      minsec      =[ "%f" ],
                                                      minutes     =[ "%f" ],
